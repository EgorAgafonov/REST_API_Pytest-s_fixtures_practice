...
#                                                                                    "очень длинная, но достаточно для "
#                                                                                    "нашего теста, и в ней нет "
#                                                                                    "названия языка",
#                                                                                    "Длинная строка, не то чтобы прям "
#                                                                                    "очень"
#                                                                                    "длинная, но"),
#                                           ("Короткая строка со словом python", "Короткая строка со словом python"),
#                                           ("Длинная строка, нам "
#                                            "достаточно будет для проверки, и в ней есть слово python",
#                                            "Длинная строка, нам достаточно будет для проверки, и в "
#                                            "ней есть слово python")],
...
@pytest.mark.parametrize("y", [10, 100, 1000], ids=["2 digit", "3 digit", "4 digit"])
@pytest.mark.parametrize('z', ['a', "ab", "abc"], ids=["1 num", "2 num", "3 num"])
def test_multiply_params(x, y, z):
    print(f"x: {x}, y:{y}, z:{z}")
    assert True
